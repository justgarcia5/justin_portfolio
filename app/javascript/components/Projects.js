            ...
            <div className="row">
              <div className="card-col col-sm">
                <div className="card hovereffect" >
                  <img src={Recipe} className="card-img-top img-res26nsive" height={220}  alt="..."/>
                  <div className="overlay">
                    <h2>RecipeApp</h2>
                    <a className="button info" href="#">Live Demo</a>
                    <br/>
                    <a className="button info" href="https://github.com/justgarcia5/recipe-app">Code <i className="gh fa fa-github fa-lg"></i></a>
                  </div>
              ...
              <div className="card-col col-sm">
                <div className="card hovereffect" >
                  <img src={Zeal} className="card-img-top" height={220}  alt="..."/>
                  <div className="overlay">
                    <h2>Initiative Tracker</h2>
                    <a className="button info" href="https://github.com/CodingZeal/initiative-tracker" target="_blank">Code <i className="gh fa fa-github fa-lg"></i></a>
                  </div>
                  <div className="card-body">
              ...
              <div className="card-col col-sm">
                <div className="card hovereffect" >
                  <img src={Tool} className="card-img-top" height={220}  alt="..."/>
                  <div className="overlay">
                    <h2>ToolShare</h2>
